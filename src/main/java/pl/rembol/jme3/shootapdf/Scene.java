...
public class Scene extends Node {
    ...
    public Scene(Application application, float length) {
        Box box = new Box(new Vector3f(-20f, -1f, -20 - length), new Vector3f(20f, 0f, 20f));
        ...
        RigidBodyControl rigidBodyControl = new RigidBodyControl(new MeshCollisionShape(box), 0f);
